...
public class KnightEntity extends TameableEntity implements IAnimatable {
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        ...
        if (this.isSitting()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.knight.sit", true));
            return PlayState.CONTINUE;
        }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        nbt.putInt("VariantB", this.getTypeVariantB());
    }
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        this.dataTracker.startTracking(DATA_ID_TYPE_VARIANTB, nbt.getInt("VariantB"));
    }
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(DATA_ID_TYPE_VARIANTB,0);
    }

    /*VARIANTS*/
    private static final TrackedData<Integer> DATA_ID_TYPE_VARIANTB =
            DataTracker.registerData(KnightEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty,
        ...
        KnightVariant variantb = Util.getRandom(KnightVariant.values(), this.random);

        setVariantB(variantb);
        return super.initialize(world, difficulty, spawnReason, entityData, entityNbt);
    }


    public KnightVariant getVariantB() {
        return KnightVariant.byId(this.getTypeVariantB() & 258);
    }

    private int getTypeVariantB() {
        return this.dataTracker.get(DATA_ID_TYPE_VARIANTB);
    }

    private void setVariantB(KnightVariant variantb) {
        this.dataTracker.set(DATA_ID_TYPE_VARIANTB, variantb.getIdb() & 258);
    }
}
